 ...
 *            Freenove Crawling Robot Controller V2.0 and V3.0 (Marked on the control board)
...
// Using external reference, measure 5V and 3.3 voltage.
  ...
  case 3:
    ...
    Serial.print(" V. ");
    if (vccVoltage > 4.9 && vccVoltage < 5.1) {
      Serial.println("OK.");
    }
    else {
      Serial.println("NG. Hardware failure.");
...
// Open power of servos.
  ...
  // Using external reference, measure power of servo voltage.
    ...
    Serial.print(" V. ");
    if (u1Voltage > 4.85 && u1Voltage < 5.1 &&
        u2Voltage > 4.85 && u2Voltage < 5.1) {
      Serial.println("OK");
    }
    else {
      Serial.println("NG. Hardware failure.");
